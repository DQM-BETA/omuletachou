...
| 16 | Líder Técnico (PR release) | lider-tecnico | sonnet | ~ | ~ | ~ | PR #222 (`homolog→main`, merge commit) criado, cobrindo Issue-pai #208 completa (Closes #208) + sub-issues #215/#216/#217 (todas CLOSED). Aguardando Gate 2 do Gerente. |
