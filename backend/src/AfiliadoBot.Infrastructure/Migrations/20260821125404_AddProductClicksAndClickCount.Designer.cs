...
namespace AfiliadoBot.Infrastructure.Migrations
{
    ...
    [Migration("20260821125404_AddProductClicksAndClickCount")]
    partial class AddProductClicksAndClickCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AfiliadoBot.Domain.Entities.JobRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AfiliadoBot.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasComputedColumnSql("setweight(to_tsvector('portuguese', immutable_unaccent(title)), 'A') || setweight(to_tsvector('portuguese', immutable_unaccent(category)), 'B') || setweight(to_tsvector('portuguese', immutable_unaccent(description)), 'C')", true);
            ...
            modelBuilder.Entity("AfiliadoBot.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
